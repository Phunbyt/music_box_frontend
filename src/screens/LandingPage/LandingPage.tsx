    ...
    return (
        <div className={classes.Wrapper}>
            ...
            <div className={classes.Section4_Wrapper}>
                <img className={classes.Section4_Image} src={searchPhone} alt='listen anytime, anywhere' />
                <div className={classes.Section4_Text}>
                    <h3 className={classes.Section4_Text1}>Find the music you want</h3>
                    <p className={classes.Section4_Text2}>Search for your favorite songs using the description, or turn on the <span style={{color:"#2DCEEF", fontStyle:'bold'}}>MusicFinder</span> feature to find the song that is playing near you.</p>
                </div>     
            </div>
                ...
                <div className={classes.Section5_Subwrapper}>
                    ...
                    <div className={classes.Section5_Category}>
                        <div className={classes.Section5_Category1}>
                            <img className={classes.Category1_Image} src={ Offline} alt='offline mode' />
                        ...
                        <div className={classes.Section5_Category2}>
                            <img className={classes.Category2_Image} src={ Hq} alt='High Quality Audio' />
                            <div className={classes.Category2_Text}>
                                <h3 className={classes.Category2_Text1}>High Quality Audio.</h3>
                                <p className={classes.Category2_Text2}>Enjoy the full range of sound.</p>
                            </div>
                            </div>
                            ...
                            <div className={classes.Section5_Category4}>
                                <img className={classes.Category4_Image} src={ UmlimitedSkips} alt='ulimited skips' />
                    ...
                    <div className={classes.Section5_SubSectionWrapper}>
                        <div className={classes.Section5_SubSection}>
                            <div className={classes.Section5_Content}>
                                ...
                                <p className={classes.Section5_BoxPremiumPrice}><span style={{ color: "#2DCEEF", fontSize:'24px',fontStyle: 'bold', letterSpacing: '0.24px' }}>$7.99</span>/month</p>
                                <p className={classes.Section5_BoxPremiumFree}>Start with 1-month free trial*</p>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={mark} alt='mark'/>
                                    <p className={classes.Section_ContentOptionsText}>Offline mood</p>
                                </div>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={mark} alt='mark'/>
                                    <p className={classes.Section_ContentOptionsText}>High quality audio</p>
                                </div>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={mark} alt='mark'/>
                                ...
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={mark} alt='mark' />
                                    <p className={classes.Section_ContentOptionsText}>Unlimited skips</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button className={classes.SectionButtonPremium}>MUSICBOX PREMIUM</button>
                    </div>
                    ...
                    <div className={classes.Section5_SubSectionWrapperWhite}>
                        <div className={classes.Section5_SubSectionWhite}>
                            <div id='music-offer'className={classes.Section5_Content}>
                                ...
                                <p className={classes.Section5_BoxPremiumPrice}><span style={{ color: "#fff", fontSize:'24px',fontStyle: 'bold', letterSpacing: '0.24px' }}>$0.00</span>/month</p>
                                <p className={classes.Section5_BoxPremiumFree}>Start with 1-month free trial*</p>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={markwhite} alt='mark'/>
                                    <p className={classes.Section_ContentOptionsText}>Online listening</p>
                                </div>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={markwhite} alt='mark'/>
                                    <p className={classes.Section_ContentOptionsText}>Regular radio</p>
                                </div>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={markwhite} alt='mark'/>
                                    <p className={classes.Section_ContentOptionsText}>With Advertisement</p>
                                </div>
                                <div className={classes.Section_ContentOptions}>
                                    <img className={classes.Section_ContentOptionsImage} src={markwhite} alt='mark' />
                                    <p className={classes.Section_ContentOptionsText}>30 skips per day</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        <button className={classes.SectionButtonWhite}>MUSICBOX PREMIUM</button>
                        </div>
                        </div>
                </div>
            </div>
