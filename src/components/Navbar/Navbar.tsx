        ...
        <div className='left-side' id={showLinks ? 'hidden' : ''}>
          ...
          <div className='search-and-user-profile'>
              ...
              >
                {allData && allData.artist ? (
                  allData.artist.length > 0 && (
                    <ul id='myUL' style={{ height: 230, overflowY: 'scroll' }}>
                      <p
                        style={{
            ...
            <div className='user-profile'>
              ...
              {firstName} {lastName}
              <i
                className='fa fa-chevron-circle-down drop-down-button'
              ...
              >
                ...
                >
                  <NavLink className='dropdown' to='/user-profile'>
                    Profile
                  </NavLink>
                  <NavLink className='dropdown' to='/' onClick={logout}>
                    Log out
                  </NavLink>
                </div>
              </i>
