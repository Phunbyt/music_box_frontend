      ...
      >
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="me-auto active" style={{marginLeft: -50, fontSize: 17}}>
              <NavLink
                activeClassName="selected-links"
                ...
                <div className="nav-link" style={{ position: "relative" }}>
                  ...
                  <span
                    style={{
                      ...
                      position: "absolute",
                      fontSize: "38px",
                      top: currentPath === "/playlists" ? "-18px" : "-3px",
                      right: currentPath === "/playlists" ? "10px" : "20px",
                    }}
                  >
                    .
                  </span>
              ...
              (location.pathname === "/playlists" ||
                ...
                <div className="path">
                  <NavLink
                    className="link-to-routes"
                    to="/playlists"
                    activeClassName="selected-links-mini"
                  >
                    Playlists
                  </NavLink>
                  <NavLink
                        ...
                        <div className="noResultModal" style={{visibility: display ? "visible" : "hidden"}}>
                          ...
                          <div className="noResultModalContent">
                            <div className="noResultMain">
                              <span className="firstText">No Results</span>
                              <br />
                              <span className="secondText">
                                MusicFinder didn't quite catch that
                              </span>
                              <br />
            ...
            >
              <NavDropdown.Item to="/" 
              onClick={() => history.push('/user-profile')}>Profile</NavDropdown.Item>
              <NavDropdown.Divider />
