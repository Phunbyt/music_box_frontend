...
import styles from './PublicPlaylistTopButtons.module.css'

const PublicPlaylistTopButtons = (props: Record<string, string>) => {
    ...
    return (
        <div className={styles.topButtons}>
            ...
            <button className={`fas fa-ellipsis-h whiteColor ${styles.topButton3}`}></button>
            </div>
        </div>
    )
}

export default PublicPlaylistTopButtons